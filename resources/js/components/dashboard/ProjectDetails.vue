        ...
        <div class="row justify-content-center">
          <div class="col-md-10 left position-relative">
            <div class="col-md-12 mt-3">
              ...
              >
              <div v-if="project.link!=''" class="mt-2 ml-2">
                <a :href="project.link"
                  ><img
                    class="img-fluid"
            ...
            <div v-show="project.youtube!=''" class="col-md-12 mt-3">
            ...
            <div v-if="incomes.length>0" class="col-md-12 mt-3">
              <h6>What You Wanna Learn From This Project</h6>

              <div v-for="income in incomes" :key="income" class="income w-80 mb-2">
            ...
            <div v-if="outcomes.length>0" class="col-md-12 mt-3">
              <h6>Outcomes</h6>

              <div v-for="outcome in outcomes" :key="outcome" class="outcomes w-80 mb-2">
                <span class="d-inline-block pt-1 pb-1 pl-2">
                  {{outcome}}
                </span>
              </div>
